...
def index():
    ...
    return render_template('nn_index.html')
...
def upload():
    if request.method == 'POST':
        ...
        if audio_file:
            ...
            # transcribed_text = speech_to_text('Speech to text audio/vp.wav')
            ...
            if text_to_speech(llm_response,f'Text to speech audio/ai.wav') == 1:
                ...
                print(round(t2-t1,2))
                # response_data = {
                #     'audio_file': send_file(audio_file_path, mimetype='audio/wav'),
